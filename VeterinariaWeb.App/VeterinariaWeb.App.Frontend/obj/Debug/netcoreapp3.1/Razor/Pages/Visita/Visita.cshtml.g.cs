#pragma checksum "C:\Veterinaria Repositorio 3\VeterinariaWeb\VeterinariaWeb.App\VeterinariaWeb.App.Frontend\Pages\Visita\Visita.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b0e32ad8b69bdba23534e76ec4b6cd7215b70391"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b0e32ad8b69bdba23534e76ec4b6cd7215b70391", @"/Pages/Visita/Visita.cshtml")]
	...
	<div class=""login-html"">
		...
		<div class=""login-form"">
			<div class=""sign-in-htm"">
				<div class=""group"">
					<label for=""user"" class=""label"">Fecha y Hora</label>
					<input id=""user"" type=""text"" class=""input"">
					<label for=""user"" class=""label"">Temperatura</label>
					<input id=""user"" type=""text"" class=""input"">
					<label for=""user"" class=""label"">Peso</label>
					<input id=""user"" type=""text"" class=""input"">
					<label for=""user"" class=""label"">Frecuencia Respiratoria</label>
					<input id=""user"" type=""text"" class=""input"">
					<label for=""user"" class=""label"">Frecuencia Cardiaca</label>
					<input id=""user"" type=""text"" class=""input"">
					<label for=""user"" class=""label"">Estado Ánimo</label>
					<input id=""user"" type=""text"" class=""input"">
...
.login-wrap{
	...
	min-height:400px;
	position:relative;
	/*background:url(https://raw.githubusercontent.com/khadkamhn/day-01-login-form/master/img/bg.jpg) no-repeat cente");
            WriteLiteral(@"r;*/
...
.login-form .group labe");
            WriteLiteral(@"l .icon:before,
