#pragma checksum "C:\Veterinaria Repositorio 3\VeterinariaWeb\VeterinariaWeb.App\VeterinariaWeb.App.Frontend\Pages\Propietario\Propietario.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2f927fdd0ea9905199fceb3f25ac31c7553abf3c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2f927fdd0ea9905199fceb3f25ac31c7553abf3c", @"/Pages/Propietario/Propietario.cshtml")]
	...
	<div class=""login-html"">
		...
		<div class=""login-form"">
			<div class=""sign-in-htm"">
				<div class=""group"">
					<label for=""user"" class=""label"">Tipo Identificación</label> <input id=""user"" type=""text"" class=""input"">
                    <label for=""user"" class=""label"">Número Identificación</label> <input id=""user"" type=""text"" class=""input"">
                    <label for=""user"" class=""label"">Nombres</label> <input id=""user"" type=""text"" class=""input"">
                    <label for=""user"" class=""label"">Apellidos</label> <input id=""user"" type=""text"" class=""input"">
                    <label for=""user"" class=""label"">Dirección</label> <input id=""user"" type=""text"" class=""input"">
                    <label for=""user"" class=""label"">Teléfono</label> <input id=""user"" type=""text"" class=""input"">
				</div>
				<div class=""hr""></div>
				<div class=""group"">
					<tab");
            WriteLiteral(@"le class=""gen-table"">
						<tr>
							<th>Propietario</th>
  						</tr>
					</table>
...
.login-wrap{
    ...
    background:url(https://image.winudf.com/v2/image1/bGl0dGxlYXBwYXMuZG9nL");
            WriteLiteral(@"ndhbGxwYXBlcnNfc2NyZWVuXzdfMTU2ODgyODc5M18wODg/screen-7.jpg?fakeurl=1&type=.jpg) no-repeat center;
